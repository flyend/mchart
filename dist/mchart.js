...
!(function(global) {
    ...
    var Graph = (function() {
        ...
        Graph.Color = (function() {
            ...
            var parse = function(color) {
                var rgba = rHEX.exec(color),
                    value, table;
                if ((table = Color2.LOOKUP_TABLE).hasOwnProperty(color)) {
                    value = defined(table.a) ? table : extend({
                        a: 1
                    }, table[color]);
                }
                if (rgba) {
            ...
            Cluster.hirschbergs = (function() {
                ...
                function align(a0, a1, p0, p1, q0, q1, score0, score1, compare, append) {
                    ...
                    //a0 is one, a1 is not empty
                        ...
                        memo = 0;
                        for (j = q0; j < q1; j++)
                            if (compare(item, a1[j]) && !memo && (memo = 1)) {
                ...
                partition: function(data, filter) {
                    ...
                    for (; i < length; i++) {
                        ...
                        for (j = i + 1; j < length; j++)
                            if (filter && filter.call(data, a, b = data[j], i, j) === true) {
                                group.push(b);
                                visited[j] = true;
                            }
                        if (!visited[i])
        ...
        Graph.Cluster.List.diff = (function(global) {
            ...
            function factoy(hirschbergs) {
                ...
                diff.fn = diff.prototype = {
                    compareTo: function(a0, a1, compare) {
                        ...
                        if (l0 - j >= i || l1 - j >= i) {
                            forEach.call(hirschbergs(a0, a1, i, l0 - j, i, l1 - j, [
                                [],
                                []
                            ], [
                                [],
                                []
                            ], compare, append), function(item) {
                                that[length++] = (item);
                            });
                            for (i = 0; i < j; i++)
            ...
            return exports;
        })(typeof window !== "undefined" ? window : this).deps(Graph.Cluster.hirschbergs);

        Graph.ZTree = (function(factoy) {
            var exports = {
                deps: function() {
                    var args = Array.prototype.slice.call(arguments, 0);
            ...
            return ZTree;
        }).deps(Graph.Cluster.List.partition);
        ...
        Graph.geo = (function() {
            ...
            function factoy(Graph) {
                ...
                Path.bounds = function(geojson) {
                    ...
                    var bounds = [
                        [360, 180],
                        [0, 0]
                    ]; //min lat and min lng, max lat and max lng
                    //bounds = [[-85.05112878, -180], [85.05112878, 180]];
            ...
            var exports = (function(global) {
                return function(Graph) {
                    return factoy.call(global, Graph);
                };
            })(this);
            if (typeof module === "object" && module.exports) {
                module.exports = exports;
        ...
        }).call(typeof window !== "undefined" ? window : this)(Graph);
     ...
     * Graph.Chart, new Graph.Chart method
     **/
    (function(Graph) {
        var defined = Graph.defined,
            extend = Graph.extend;
        ...
        function rescale(g, width, height, ratio, tx, ty) {
            var canvas = g.canvas;
            tx = Graph.pack("number", tx, 0);
            ty = Graph.pack("number", ty, 0);
            ...
            var onStart = function(e, chart) {
                ...
                chart.rangeSlider.forEach(function(slider, i) {
                    ...
                    rangeSelector.dragging = slider.getTarget(sx, sy) === -1 && Intersection.rect({
                        ...
                        x: pane.plotX,
                        y: pane.plotY,
                        width: pane.plotX + pane.plotWidth,
                        height: pane.plotY + pane.plotHeight
                    }) && 1; //no rangeSelector;
            ...
            function factory(Graph, Event) {
                ...
                function bindAll(chart, removed) {
                    ...
                    var events = {
                            ...
                            mouseup: {
                                el: document,
                                listener: globalEvent.drop
                            },
                            mousewheel: globalEvent.zoom,
                            DOMMouseScroll: globalEvent.zoom,
                            resize: {
                                el: window,
                                listener: globalEvent.resize
                            },
                            visibilitychange: {
                                el: document,
                                listener: globalEvent.visible
                            },
                        ...
                        event;
                    for (var p in events)
                        if (event = events[p], events.hasOwnProperty(p))
                ...
                function event(chart) {
                    ...
                    (function(chart) {
                        ...
                        Event.hasTouch ? new Graph.Touch(container).on({
                            tap: touchTap,
                            press: touchPress,
                            swipe: touchSwipe,
                            pinch: function(e) {
                ...
                event.destroy = function(chart) {
                    var container = chart.container;
                    if (container) {
                        Event.hasTouch ? new Graph.Touch(container).free() : bindAll(chart, true);
                    }
                };
        ...
        })(typeof window !== "undefined" ? window : this).deps(Graph, Event);
        Chart.angleInQuadrant = (function() {
            ...
            function factoy(shapes, options) {
                ...
                maxRadius = Math.max(
                    radius + fontHeight,
                    Math.min(radius / fontHeight, Math.max.apply(Math, quadrants.map(function(item) {
                        return item.length;
                    })))
                );
        ...
        Chart.Series = (function(global) {
            ...
            function factoy(global, Graph, List) {
                ...
                var prediction = function(values) {
                    ...
                    mean = sum / n, sum = 0;
                    each(function(a, b) {
                        sum += (a - mean) * (a - mean), sum += (b - mean) * (b - mean);
                    });
                        ...
                        if (diff = (end - start)) {
                            ...
                            for (; start < end; start++, j++) {
                                ...
                                if ((type === "pie" || type === "funnel")) {
                                    data[start] = isObject(item) || isArray(item) ? item : {
                                        value: item
                                    }; //legend data
                                }
                            }
                ...
                Series.normalize = function(series) {
                    ...
                    var ztree = new Graph.ZTree(series, ["type", "stack"]),
                        root;
                    ...
                    root = ztree.update(function(item) {
                        ...
                        var isHigh;
                        var m = endIndex - startIndex,
                            n = item.length,
                            i, j;
                        var data, source, value, x = null,
                            y = null;
                        ...
                        for (j = 0; j < m; j++) {
                            ...
                            var negativeValue = MAX_VALUE,
                                positiveValue = MIN_VALUE;
                            var positiveX = MIN_VALUE,
                                negativeX = MAX_VALUE,
                                positiveXSum = 0,
                                negativeXSum = 0;
                            var positiveY = MIN_VALUE,
                                negativeY = MAX_VALUE,
                                positiveYSum = 0,
                                negativeYSum = 0;
        ...
        })(typeof window !== "undefined" ? window : global).deps(Graph, Graph.Cluster.List);
        Chart.scale = rescale;
        Chart.fixLinePixel = fixLinePixel;
        Chart.fixPixelHalf = function() {
            var args = [].slice.call(arguments, 0),
                sub = args.pop(),
                lineWidth = sub;
    ...
    }).call(typeof window !== "undefined" ? window : this).deps(Graph, Graph.Text);
    ...
    (function(global, Graph) {
        ...
        var Chart = function(element, options) {
                ...
                if (defined(chartOptions.backgroundImage)) {
                    parseImageURI(this.background = {
                        completed: false,
                        repeat: "no-repeat",
                        position: [0, 0],
                        size: [0, 0]
                    }, chartOptions.backgroundImage);
                }
        ...
        chartProto = {
            ...
            linkAxis: function() {
                ...
                var setAxis = function(node) {
                    ...
                    n = opera.length;
                    while ((j += 2) < n)
                        if (isTrued = opera[j].apply(null, [name, type])) {
                            opera[-~j](isTrued);
                        }
                ...
                (function dfs(root) {
                    ...
                    if (next && children && (n = children.length))
                        while (++i < n) {
                            dfs(children[i]);
                        }
                })(this.chartTree);
            ...
            linkRangeSelector: function() {
                ...
                var getAxis = function(rangeSelectorOptions) {
                    ...
                    if (!rangeSelectorOptions.hasOwnProperty("xAxis")) {
                        rsp = extend({
                            xAxis: 0
                        }, rangeSelectorOptions); //default axis
                    }
                    //console.log(rsp)
                    for (p in rsp)
                        if (mapAxis.hasOwnProperty(p) && isNumber(axisIndex = rsp[p])) {
                            data = [];
                            (mapAxis[p][axisIndex] || []).forEach(function(series) {
                                series.selected !== false && (
                                    data = series.data,
                                    series.type === "candlestick" && (data = data.map(function(d) {
                                        return d.close;
                                    }))
                                );
                            });
            ...
            renderAll: function() {
                ...
                var onRenderer = function() {
                    [{
                        ...
                        {
                            z: 9,
                            render: Renderer.credits
                        },
                        {
                            z: 8,
                            render: Renderer.toolbar
                        },
                        {
                            z: 4,
                            render: Renderer.axis
                        },
                        {
                            z: 5,
                        ...
                        if (defined(Graph.Animation) && animationCharts.length) {
                            ...
                            shapes.forEach(function(item) {
                                var shape = item[0],
                                    step = item[1];
                                Animation.addAnimate(shape, {
                                    duration: chart.eventAction === "update" ?
                            ...
                            if (Intersection.rect({
                                ...
                                if (!doInited && (doInited = !doInited)) {
                                    ...
                                    script.onload = function() {
                                        ...
                                        new Graph.Chart.Dashboard(chart);
        ...
        Graph.Chart.fn = Graph.Chart.prototype = {
            ...
            init: function(canvas, options) {
                ...
                var add = function(name, axis) {
                    pack("array", axis, isObject(axis) ? [axis] : [{
                        enabled: false
                    }]).forEach(function(item) {
        ...
        Legend.prototype = {
            ...
            onScroll: function(callback) {
                ...
                var animateTo = function(clickedItem) {
                    ...
                    if (defined(Graph.Animation) /* && (endY < legend.height)*/ ) {
                        var value = 0;
                ...
                if (hasTouch) {
                    //new Graph.Touch(canvas).on("tap", onClick, false);
                    new Graph.Touch(canvas).on({
                        tap: onClick
                    });
    ...
    })(typeof window !== "undefined" ? window : global, Graph.Chart);;
    (function(global, Graph) {
        var Chart = Graph.Chart;
        ...
        var symbolCallout = function(x, y, w, h, options) {
            ...
            var path = [{
                ...
                }, //bottom
                {
                    x: x,
                    y: y + h / 2 + arrow
                }, //triangle left bottom(2/3), default left
                {
                    x: x - arrow,
                    y: y + h / 2
        ...
        Axis.prototype = {
            Item: function() {
                ...
                tick.radiusAxis = function(item) {
                    ...
                    if (tickWidth > 0) {
                        ...
                        context.transform(
                            Math.cos(startAngle), Math.sin(startAngle), -Math.sin(startAngle), Math.cos(startAngle),
                            cx,
                            cy
                        );
                ...
                tick.adjustLabel = function(tick, i, params) {
                    ...
                    if (defined(text.ellipse)) {
                        ...
                        if (type === "logarithmic" && isNumber(logarithmic.base) && defined(logarithmic.pow)) {
                            ...
                            context.fillText(
                                powN, !opposite ? width - context.measureText(powN).width / 2 : text.width * 0.8,
                                0
                            );
                        }
                        context.restore();
            ...
            addTooltip: function(x, y, callback) {
                ...
                var onMove = function(area) {
                    ...
                    if (isNumber(startValue, true) && isNumber(endValue, true) && Intersection.rect({
                            x: x,
                            y: y
                        }, area)) {
        ...
        RangeSelector.prototype = {
            ...
            getTarget: function(x, y) {
                ...
                if (Intersection.rect({
                        ...
                        x: startZoom.left,
                        y: startZoom.top,
                        width: startZoom.left + startZoom.width,
                        height: startZoom.top + this.height
                    })) {
                    target = 1;
                        ...
                        x: endZoom.left,
                        y: endZoom.top,
                        width: endZoom.left + endZoom.width,
                        height: endZoom.top + height
                    })) {
                    target = 2;
                }
                return target;
            ...
            getRangeValue: function() {
                ...
                if (this.hasRange || this.dragging) {
                    ...
                    context.font = [fontStyle.fontStyle, fontStyle.fontWeight,
                        fontStyle.fontSize + "/" + fontStyle.lineHeight, fontStyle.fontFamily
                    ].join(" ");
    ...
    })(typeof window !== "undefined" ? window : typeof global !== "undefined" ? global : this, Graph);;
    ...
    (function(global, Chart) {
                                ...
                                for (i = 0; i < n; i++) {
                                    ...
                                    if (coordinate === "xy") {
                                        ...
                                        if (isArray(shape.source) && shape.source.length > 1) {
                                            ...
                                            y += plotY;
                                            highY = isNumber(shape.source[2]) ? interpolate.apply(null, [shape.source[2], minValue, maxValue].concat(
                                                reversed === true ? [0, plotHeight] : [plotHeight, 0]
                                            )) : NaN;
                                            highY += plotY;
        ...
        }).call(typeof window !== "undefined" ? window : this).deps(Graph.Math, Numeric);
        ...
        Line.prototype = {
            ...
            init: function(options) {
                ...
                while (++i < n) {
                    newSeries = [];
                    for (j = 0, nn = panel[i].series.length; j < nn; j++)
                        if ((series = panel[i].series[j]).type === this.type) {
            ...
            getShape: function(x, y, shared) {
                ...
                if (shared === false) {
                    shapes = results.map(function(item) {
                        return item.shape;
                    });
                    reset(shapes);
                    kdtree = KDTree(shapes);
        ...
        var AreaRange = (function() {
            function factoy(Graph, AreaSpline) {
                var extend = Graph.extend;

                var arrayFilter = Graph.Cluster.List.filter;
        ...
        var addLayout = (function(global) {
            ...
            function factoy() {
                var computeColumn = function(group, width, height, groupCounting, groupLength) {
                    ...
                    var n = group.length,
                        m = series.maxLength; //group[0].shapes.length;
                    var maxLength = m;
                ...
                var computeBar = function(group, width, height, groupCounting, groupLength) {
                    ...
                    //console.log(plotY, plotHeight, plotWidth)
                ...
                Bar: (function(global) {
                    ...
                    function factoy(Column) {
                        ...
                        for (var p in methods)
                            if (({}).hasOwnProperty.call(methods, p)) {
                                (function(p) {
                                    barProp[p] = function() {
                            ...
                            getShape: function(x, y, shared) {
                                ...
                                for (var i = 0; i < length; i++) {
                                    ...
                                    for (var j = 0; j < shapes.length; j++) {
                                        ...
                                        area = {
                                            x: shape.x0,
                                            y: shape.y0 - shape.margin,
                                            width: shape.x1,
                                            height: shape.y1 + shape.margin
                                        };
                                        if (shared) {
                    ...
                    if (reversed) {
                        ...
                        if (!turningFlag && curTurningHeight + height > turningHeight) {
                            ...
                            points = points.concat([{
                                    x: xTopRight - nextWidth,
                                    y: yTop + turningHeight - curTurningHeight
                                },
                                {
                                    x: xTopRight - nextWidth,
                                    y: yBottom
                    ...
                    if (isInside(series)) {
                        ...
                        for (j = 0, dl = shapes.length; j < dl; j++) {
                            ...
                            if (series.selected !== false && !shape.isNULL && Intersection.line({
                                    ...
                                    x: shape.x,
                                    y: shape.y,
                                    width: pack("number", (series.marker || {}).radius, 5) * 2
                                })) {
                                shape.current = j;
                                results.push({
                                    shape: shape,
    ...
    (function(global, Chart) {
        ...
        }).call(typeof window !== "undefined" ? window : this).deps(Graph.geo, Color);
        /*
         * Class Map
         */
        ...
        Subset.prototype = {
            ...
            scale: function(width, height, padding) {
                ...
                var minMax = function(d) {
                    var max = Math.max.apply(Math, nodes.map(function(item) {
                            return item[d] + item.radius;
                        })),
                        min = Math.min.apply(Math, nodes.map(function(item) {
                            return item[d] - item.radius;
                        }));
                    return {
                        min: min,
            ...
            shapes: function(series, options) {
                ...
                overlaps.forEach(function(item) {
                    var maps = item.sets.map(function(i) {
                        return nodes[i];
                    });
                    Union.area(maps);
                    var arcs = Union.arcs;
            ...
            function factoy(Numeric) {
                ...
                return function(type, options) {
                    ...
                    var addRect = function(shape, series, f0, f1, f2) {
                        var tickWidth = series.tickWidth,
                            tickHeight = series.tickHeight;
                        var x = getXY(shape, f0, f1),
                            y = x.y,
                            value = x.value;
                        x = x.x;
    ...
    (function(global, Chart) {
        ...
        }).call(typeof window !== "undefined" ? window : this).deps(Graph);
    ...
    (function(global, Chart) {
            ...
            var Sankey = function() {
                ...
                sankey.data = function(data) {
                    (data || []).forEach(function(d, i) {
                        var source = d.source;
                        typeof source !== "undefined" && nodes.push({
                            name: source,
                            data: d
                        });
                        links.push({
                    ...
                    data.forEach(function(d) {
                        var target = d.target;
                        typeof target !== "undefined" && nodes.push({
                            name: target,
                            data: d
                        });
                    });
        ...
        }).call(typeof window !== "undefined" ? window : this).deps(Graph.Numeric);
    ...
    (function(global, Chart) {
        ...
        var Linked = (function() {
            ...
            var curveStep = function(source, target, options) {
                ...
                if (source && target) {
                    var smoothing = 0.5;
                    var points = [{
                            x: source.x + source.width * smoothing,
                        ...
                        null,
                        {
                            x: target.x + target.width * smoothing,
            ...
            var curveBasis = function(source, target, options) {
                ...
                var points = [{
                        x: abox.x + abox.width * smoothing,
                        y: abox.y - sourceSpacing
                    }, //source right
                    {
                        x: abox.x + abox.width * smoothing,
                        y: abox.y + abox.height + sourceSpacing
                    }, //source bottom
                    {
                        x: abox.x - sourceSpacing,
                        y: abox.y + abox.height * smoothing
                    }, //source left
                    {
                        x: abox.x + abox.width + sourceSpacing,
                        y: abox.y + abox.height * smoothing
                    }, //source top

                    {
                        x: bbox.x + bbox.width * smoothing,
                        y: bbox.y - targetSpacing
                    }, //target right
                    {
                        x: bbox.x + bbox.width * smoothing,
                        y: bbox.y - targetSpacing
                    ...
                    {
                        x: bbox.x - targetSpacing,
                        y: bbox.y + bbox.height * smoothing
                    }, //target left
                    {
                        x: bbox.x + bbox.width + targetSpacing,
                        y: bbox.y + bbox.height * smoothing
                    } //target top
                ];
            ...
            function merged(data) {
                ...
                while (++i < n)
                    if ((node = data[i]) && defined(node.source)) {
                        maps[node.source] = 1;
                        ret.push({
                            source: node.source,
                            target: node.target,
                ...
                i = -1;
                while (++i < n)
                    if ((node = data[i]) && defined(node.target) && !(hasProps.call(maps, node.target)) && (maps[node.target] = 1)) {
                        ret.push({
                            source: node.target,
                            target: null,
                            index: i
                        ...
                        if (i ^ j && target === source) {
                            if (!(hasProps.call(sourcelinks, a.source))) {
                                ...
                                clusters.push({
                                    name: b.source,
                                    index: i,
                                    source: clusters[clusters.length - 1].source,
                                    target: b
                                });
                            }
            ...
            adjacency.nodes = function() {
                ...
                adjacency.matrix();
                while (++i < n)
                    if ((node = data[i]) && !(hasProps.call(maps, node.source)) && (maps[node.source] = 1)) {
        ...
        var addLayout = (function(global) {
            ...
            function radialTreeLayout(px, py, pwidth, pheight, shapes) {
                new Graph.Layout.RadialTree(shapes, {
                    width: pwidth,
                    height: pheight,
                    margin: TRouBLe(py, 0, 0, px)
                });
        ...
        diagramProto = {
            ...
            drawShape: function(context, shape, series) {
                ...
                (defined(shape.path) ? Symbol.path : Symbol[symbol] ? Symbol[symbol] : Symbol.square).apply(
                    shape.path, [linePixel.x, linePixel.y, linePixel.width, linePixel.height, radius]
                )(context);
                context.fill();
                borderWidth > 0 && (context.lineWidth = borderWidth, context.strokeStyle = borderColor, context.stroke());
                context.restore();
    ...
    (function(callback) {
        ...
        function runAnimation(animators) {
            ...
            var isAnim = true,
                ...
                ii = animators.length;
            for (; i < ii; i++)
                if (!(ani = animators[i]).paused && !ani.done) {
                    var nextd = ani.next,
                        target = ani.target;
    ...
    (function(global) {
        ...
        if (typeof module === "object" && module.exports) {
            ...
            (typeof Graph !== "undefined" ? Graph : global).Touch = Touch;
        }
    })(typeof window !== "undefined" ? window : this);;
    if (Graph.Chart.hasTouch) {
        Graph.Chart.setOptions({
            legend: {
                itemMarginBottom: 12
            },
            tooltip: {
    ...
    (function() {
            ...
            grid = function(Grid) {
                ...
                grid = Grid.prototype = {
                    init: function(data, options) {
                        ...
                        this.options = settings = n === 1 ?
                            extend(defaultOptions, {
                                nodes: pack("array", data && data.data, [])
                            }, data || {}) :
                            extend(defaultOptions, {
                                nodes: pack("array", data, [])
                            }, options || {});
                    ...
                    setLayout: function() {
                        ...
                        col = Math.max.apply(Math, groups.map(function(group) {
                            return group.length;
                        }));
        ...
        function factoy(Graph) {
            ...
            var Intersection = Graph.Geometry.Intersection;
                        ...
                        sort: function(sort) {
                            (function(node, callback) {
                                ...
                                while ((node = first.pop()) != null) {
                                    second.push(node);
                                    if ((children = node.children) && (i = -1, n = children.length))
                                        while (++i < n)
