(function(global, Graph) {
    ...
    var interpolate = Graph.Numeric.interpolate;
...
(function(global, Graph) {
    ...
    Dashboard.prototype = {
        init: function(chart) {
            ...
            var Toolbar = Graph.Chart.Toolbar;
            ...
            var panel = new Graph.Chart.Panel(chart.container, {series: chart.series.map(function(series, i){
