(function(global, Chart){
    ...
    var relayout = require("./layout").deps(Graph.Math, Numeric);
    ...
    */
    ...
    var Spline = require("spline").deps(Graph, Line);

    var Area = require("area").deps(Graph, Line, Renderer.area);

    var AreaSpline = require("areaspline").deps(Graph, Area);

    var AreaRange = require("arearange").deps(Graph, AreaSpline);
