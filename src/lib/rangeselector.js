/**
 * Class Graph.RangeSelector
 * new Graph.RangeSelector(Canvas, options = {})
*/
"use strict";
...
;(function(global, Graph){
    ...
    var interpolate = Chart.interpolate;

    var mathRound = Chart.round;

    var fixLinePixel = Chart.fixLinePixel;

    var Event = Chart.Event;

    var Intersection = Chart.Intersection;
    ...
    if(defined(Graph.Chart)){
        Graph.Chart.RangeSelector = RangeSelector;
    }
    ...
    if(typeof module === "object" && module.exports){
        ...
        define(RangeSelector);
    else{
        global.RangeSelector = RangeSelector;
    }
})(typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : this, Graph);